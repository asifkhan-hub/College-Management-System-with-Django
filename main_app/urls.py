...
urlpatterns = [
    ...
    # Student
    path('fee/detail/', student_views.fee_detail, name='fee_detail'),
    ...
    path('student/view/result/', student_views.student_view_result,
     ...
     # Online Classes
    path('online-classes/', student_views.online_class_list, name='online_class_list'),
    path('online-classes/<int:pk>/',student_views.online_class_detail, name='online_class_detail'),

#     for checking student fee is pending or paid
    path('pending-fees/', staff_views.pending_fees_view, name='pending-fees'),
    path('paid-fees/', staff_views.paid_fees_view, name='paid-fees'),
    ###########################
#     path('update_fee/<int:student_id>/', hod_views.update_student_fee, name='update_student_fee'),
]
