...
def staff_home(request):
    ...
    pending_fees = StudentFee.objects.filter(student__course=staff.course, is_paid=False)
    paid_fees = StudentFee.objects.filter(student__course=staff.course, is_paid=True)
